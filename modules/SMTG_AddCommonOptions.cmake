...
if(SMTG_WIN)
    option(SMTG_CREATE_BUNDLE_FOR_WINDOWS "Create Bundle on Windows for the Plug-ins (New since VST 3.6.10!)" OFF)
endif(SMTG_WIN)

# Specific Windows Stuff
# Create Symbolic Link for the Plug-ins
if(SMTG_WIN)
    set(DEF_OPT_LINK OFF) # be sure to start visual with admin right or adapt the user Group Policy when enabling this
else()
